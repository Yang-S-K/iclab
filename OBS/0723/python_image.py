        ...
        if (self.right_deep_sum > self.left_deep_sum) or self.image.line_at_left or self.line_at_left_single or self.door_at_right: #turn head 右轉
            ...
            if (self.image.center_deep > 8) and (not self.yb):                   #turn head 左轉 前後修正 越大越遠
                ...
                while ( self.image.center_deep < 7 ) and status.running and (not self.yb):
                    ...
                    self.walk.move('small_back') 
                    #sys.stdout.write("\033[H\033[J")
            if abs(self.walk.get_imu()) < 60:                           #turn head 旋轉角度  左轉 越大轉越多
                while abs(self.walk.get_imu()) < 60 and status.running:
    ...
    def main(self):
        ...
        #=============================strategy=============================
            ...
            if self.preturn_left:
                while abs(self.walk.get_imu()) < 30 and status.running:
            ...
            #         pass
                ...
                # elif ( self.image.left_deep < 15 ) and ( self.image.right_deep < 15 ) and ( self.image.center_deep < 15 ) and (1000 > (max(send.color_mask_subject_size[1]))<5000):
                #     self.yb = True
