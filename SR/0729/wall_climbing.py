...
FIRST_FORWORD_CHANGE_LINE  = 65000                    #小前進判斷線
SECOND_FORWORD_CHANGE_LINE = 60000                    #前進判斷線
THIRD_FORWORD_CHANGE_LINE  = 40000                   #大前進判斷線
UP_LADDER_DISTANCE         = 70000                    #最低上板需求距離
...
#CW主策略
    ...
    #畫面顯示繪畫資訊    
        send.drawImageFunction(1, 0, BLUE_MID, BLUE_MID, 0, 240, 255, 0, 0)   #基準線
