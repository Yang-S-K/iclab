...
ROUTE_PLAN_LAYER_ONE       = [0,1500,1,17]
ROUTE_PLAN_LAYER_TWO       = [0,-1200,0,0]# 
ROUTE_PLAN_LAYER_TREE      = [0,0,-2,2,  0,-800,5,0]
ROUTE_PLAN_LAYER_FORE      = [0, 0,0,1,-300,-1000,8,7]
ROUTE_PLAN_LAYER_FIVE      = [0,0,6,4]
...
DOWN_WARNING_DISTANCE      = 8                      #下板危險距離
GO_UP_DISTANCE             = 23                    #上板距離
GO_DOWN_DISTANCE           = 18                     #下板距離
