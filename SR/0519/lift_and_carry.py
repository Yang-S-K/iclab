...
ROUTE_PLAN_LAYER_TWO       = [0,-1200,0,0]# 
ROUTE_PLAN_LAYER_TREE      = [  0,800,-2,5]
ROUTE_PLAN_LAYER_FORE      = [0,-800,5,3,   -300,-1000,8,0]
ROUTE_PLAN_LAYER_FIVE      = [0,0,6,0]
...
UP_WARNING_DISTANCE        = 10                    #上板危險距離
DOWN_WARNING_DISTANCE      = 6                      #下板危險距離
...
#LC主策略
    ...
    def main(self,strategy):
        ...
        if self.layer <4:
            ...
            send.sendHeadMotor(2,self.head_Vertical-15,100)#垂直
    ...
    #邊緣判斷,回傳機器人走路速度與走路模式
        if ((self.distance[0] < GO_UP_DISTANCE+12) and (self.distance[1] < GO_UP_DISTANCE+12) and\
           ...
           self.state = "上板"
           return 'ready_to_lc'  
        elif ((self.distance[0] < GO_DOWN_DISTANCE+15) and (self.distance[1] < GO_DOWN_DISTANCE+3) and\
           (self.distance[2] < GO_DOWN_DISTANCE+3) and (self.distance[3] < GO_DOWN_DISTANCE+3) and\
           (self.distance[4] < GO_DOWN_DISTANCE+3) and (self.distance[5] < GO_DOWN_DISTANCE+15)) and\
