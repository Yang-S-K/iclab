...
FIRST_FORWORD_CHANGE_LINE  = 90000                    #小前進判斷線
SECOND_FORWORD_CHANGE_LINE = 80000                    #前進判斷線
THIRD_FORWORD_CHANGE_LINE  = 60000                   #大前進判斷線
UP_LADDER_DISTANCE         = 110000                    #最低上板需求距離
...
#CW主策略
    ...
    def keep_head(self):
        ...
        send.sendHeadMotor(2,self.now_head_Vertical - round(y_degree * 4096 / 360 *0.35), 35)   #352
        self.now_head_Vertical = self.now_head_Vertical - round(y_degree * 4096 / 360 *0.15)
    ...
    #畫面顯示繪畫資訊    
        ...
        send.drawImageFunction(2, 0, int(self.blue_x_middle), int(self.blue_x_middle), 0,240, 255, 255, 0) #物件中心
        send.drawImageFunction(3, 0, 0, 320, TARGET_LINE,TARGET_LINE, 255, 0, 0) #物件中心
        send.drawImageFunction(4, 0, 0, 320,int(self.blue_y_middle),int(self.blue_y_middle), 255, 255, 0) #物件中心
