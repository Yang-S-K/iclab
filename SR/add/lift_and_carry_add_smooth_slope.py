...
#LC主策略
                ...
                if self.layer < 4:
                    ...
                    if (self.distance[0] < GO_UP_DISTANCE and min(self.distance[3],self.distance[4],self.distance[5]) > GO_UP_DISTANCE) or\
                        ...
                        self.state   = "!!!右平移,左旋!!!"
                         ...
                         (min(self.distance[0],self.distance[1],self.distance[2]) == self.distance[2] and min(self.distance[3],self.distance[4],self.distance[5]) == self.distance[4]):
                        self.forward = BACK_MIN + FORWARD_CORRECTION 
    ...
    def theta_change(self):
        ...
        slope = self.smooth_slope  # 輸出原本的slope值
