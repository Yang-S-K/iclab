...
ROUTE_PLAN_LAYER_ONE       = [3000,0,0,10,   0,0,-8,3]
# ROUTE_PLAN_LAYER_ONE       = [700,0,-5,5]
ROUTE_PLAN_LAYER_TWO       = [0,500,5,3]
ROUTE_PLAN_LAYER_TREE      = [-200,-700,-2,5]
ROUTE_PLAN_LAYER_FORE      = [1000,500,0,6,   0,900,-7,4]
ROUTE_PLAN_LAYER_FIVE      = [100,1100,-1,6]
ROUTE_PLAN_LAYER_SIX       = [0,0,8,7]
ROUTE_PLAN = [
           ...
           return 'ready_to_lc'
            ...
            #即將踩板
                ...
                if max(self.distance[0],self.distance[1],self.distance[2])>30:
                    ...
                    self.theta_change()
                    self.state = "!!!小心踩板,後退!!!"
            elif self.layer >= 4 and (self.distance[0] <= DOWN_WARNING_DISTANCE) or (self.distance[1] <= DOWN_WARNING_DISTANCE) or (self.distance[2] <= DOWN_WARNING_DISTANCE) or (self.distance[3] <= DOWN_WARNING_DISTANCE) or (self.distance[4] <= DOWN_WARNING_DISTANCE) or (self.distance[5] <= DOWN_WARNING_DISTANCE): 
