...
ROUTE_PLAN_LAYER_ONE       = [0,-1600,0,7]
ROUTE_PLAN_LAYER_TWO       = [0,-800,8,3]# 
ROUTE_PLAN_LAYER_TREE      = [  1600,0,0,7   ,0, 0,-5,3]
ROUTE_PLAN_LAYER_FORE      = [800, 0,0,5, -300,-1000,8,8]
...
DOWNBOARD_LAYER_FOUR_U       = True  #下U形板
...
##判斷值
FOOTBOARD_LINE             = 220                   #基準線
UP_WARNING_DISTANCE        = 5                    #上板危險距離
DOWN_WARNING_DISTANCE      = 0                      #下板危險距離
GO_UP_DISTANCE             = 19                    #上板距離
GO_DOWN_DISTANCE           = 13                     #下板距離
